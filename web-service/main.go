...
func main() {
	// gin.Default is a router that handles web traffic
	router := gin.Default()

	// These are my routes that router will serve over localhost:8080
...
// addAlbum adds an album to the slice of albums.
